...
!1,h=0;h<N.length;h+=1){var k=N[h];g||e!==a&&k in e&&(b[k]=(b[k]||0)+1);b[k]&&(m=!0)}if(m){e=!1;if(g||d&&d.__redom_mounted)A(a,g?"onremount":"onmount"),e=!0;for(;d;){a=d.parentNode;m=d.__redom_lifecycle||(d.__redom_lifecycle={});for(var r in b)m[r]=(m[r]||0)+b[r];if(e)break;else{if(d===document||Q&&d instanceof window.ShadowRoot||a&&a.__redom_mounted)A(d,g?"onremount":"onmount"),e=!0;d=a}}}else a.__redom_mounted=!0;return c},A=function(a,c){"onmount"===c||"onremount"===c?a.__redom_mounted=!0:"onunmount"===
c&&(a.__redom_mounted=!1);var b=a.__redom_lifecycle;if(b){var d=a.__redom_view,g=0;d&&d[c]&&d[c]();for(var e in b)e&&g++;if(g)for(a=a.firstChild;a;)b=a.nextSibling,A(a,c),a=b}},E=function(a,c,b){a=f(a);if(void 0!==b)a.style[c]=b;else if(w(c))a.setAttribute("style",c);else for(var d in c)E(a,d,c[d])},F=function(a,c,b){a=f(a);var d=a instanceof SVGElement;if(void 0!==b)if("style"===c)E(a,b);else if(d&&x(b))a[c]=b;else if("dataset"===c)for(var g in b)a.dataset[g]=b[g];else if(!d&&(c in a||x(b)))a[c]=
b;else if(d&&"xlink"===c)for(var e in b)a.setAttributeNS("http://www.w3.org/1999/xlink",e,b[e]);else a.setAttribute(c,b);else for(var m in c)F(a,m,c[m])},G=function(a){return document.createTextNode(null!=a?a:"")},H=function(a,c){for(var b=0;b<c.length;b+=1){var d=c[b];if(0===d||d)if("function"===typeof d)d(a);else if(w(d)||"number"===typeof d)a.appendChild(G(d));else{var e=f(d);e&&e.nodeType?h(a,d):d.length?H(a,d):"object"===typeof d&&F(a,d)}}},O=function(a){return w(a)?p(a):f(a)},f=function(a){return a.nodeType&&
a||!a.el&&a||f(a.el)},w=function(a){return"string"===typeof a},x=function(a){return"function"===typeof a},B={},p=function(a){for(var c=[],b=arguments.length-1;0<b--;)c[b]=arguments[b+1];if(w(a))b=(B[a]||(B[a]=z(a))).cloneNode(!1);else if(a&&a.nodeType)b=a.cloneNode(!1);else if(x(a))b=new (Function.prototype.bind.apply(a,[null].concat(c)));else throw Error("At least one argument required");H(f(b),c);return b};p.extend=function(a){for(var c=[],b=arguments.length-1;0<b--;)c[b]=arguments[b+1];b=B[a]||
(B[a]=z(a));return p.bind.apply(p,[this,b].concat(c))};var I=function(a){for(var c=[],b=arguments.length-1;0<b--;)c[b]=arguments[b+1];b=f(a);for(c=v(a,c,b.firstChild);c;)b=c.nextSibling,l(a,c),c=b},R=function(a){return function(c){return c[a]}},C=function(a,c,b){this.View=a;this.initData=b;this.oldLookup={};this.lookup={};this.oldViews=[];this.views=[];null!=c&&(this.lookup={},this.key=x(c)?c:R(c))};C.prototype.update=function(a,c){for(var b=this.View,d=this.key,e=this.initData,q=null!=d,m=this.lookup,
h={},k=Array(a.length),r=this.views,n=0;n<a.length;n++){var l=a[n];if(q){var p=d(l);var t=m[p]||new b(e,l,n,a);h[p]=t;t.__redom_id=p}else t=r[n]||new b(e,l,n,a);t.update&&t.update(l,n,a,c);f(t.el).__redom_view=t;k[n]=t}this.oldViews=r;this.views=k;this.oldLookup=m;this.lookup=h};var P=function(a,c,b,d){return new u(a,c,b,d)},u=function(a,c,b,d){this.__redom_list=!0;this.View=c;this.initData=d;this.views=[];this.pool=new C(c,b,d);this.el=O(a);this.keySet=null!=b};u.prototype.update=function(a,c){void 0===
a&&(a=[]);var b=this.keySet,d=this.views,e=b&&this.lookup;this.pool.update(a,c);c=this.pool;a=c.views;c=c.lookup;if(b)for(var f=0;f<d.length;f+=1){var h=d[f].__redom_id;h in c||l(this,e[h])}I(this,a);b&&(this.lookup=c);this.views=a};u.extend=function(a,c,b,d){return u.bind(u,a,c,b,d)};P.extend=u.extend;var J=function(a,c){this.el=G("");this.visible=!1;this.view=null;this._placeholder=this.el;a instanceof Node?this._el=a:this._View=a;this._initData=c};J.prototype.update=function(a,c){var b=this._placeholder,
